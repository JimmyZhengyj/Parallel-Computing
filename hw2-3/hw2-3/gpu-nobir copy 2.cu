...
void simulate_one_step(particle_t* parts, int num_parts, double size) {
    ...
    thrust::device_ptr<int> ptr(bin_count);
    ...
    thrust::device_ptr<int> bin_start_wrapper(bin_count);
    ...
    add_particle_to_bin_gpu<<<blks, NUM_THREADS>>>(parts, bins_array, bin_count, num_parts, dim);
